...
lab1_question1 = Quiz(
    question={
        "question": "Which process successively adds noise to the image till it is pure noise?", "options" : [
            "Reverse Process",
            "Forward Process",
            "Both of the Above",
            "None of the Above",
...
lab1_question2 = Quiz(
    question={
        "question": "Which AWS service provides a catalogue of pre-trained models to accelerate development?", "options":[
            "S3",
            "Lambda",
            "JumpStart",
            "CodeCommit",
...
lab2_question1 = Quiz(
    question={
        "question": "Which process can allow trained diffusion models to generate images of objects it cannot generate presently?",
        "options": [
            "Prompt Engineering",
            "Quantization",
...
lab2_question2 = Quiz(
    question={
        "question": "Which model was selected for fine-tuning in this lab?",
        "options": [
